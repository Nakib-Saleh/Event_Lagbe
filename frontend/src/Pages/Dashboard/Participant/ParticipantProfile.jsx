        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div>
            ...
            <div className="flex gap-4 text-sm text-gray-600 mt-1">
              ...
              <span>{profileData.bookmarkedEventIds?.length || 0} Bookmarked Events</span>
              <span>{profileData.registeredEventIds?.length || 0} Registered Events</span>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="form-control">
            ...
            {isEditing ? (
              ...
              <p className="text-gray-700">{profileData.institution || 'Not provided'}</p>
            )}
          </div>
          ...
          <div className="form-control">
            <label className="label">
              <span className="label-text font-medium">Interested Skills</span>
            </label>
