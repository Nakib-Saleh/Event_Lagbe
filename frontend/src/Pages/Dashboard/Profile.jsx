    ...
    <div className="max-w-5xl mx-auto mt-6">
      ...
      <div className="relative h-60 bg-gray-200 rounded-lg  shadow-sm">
        ...
        <div className="absolute -bottom-14 left-6 z-50 flex items-end">
          <div className="w-28 h-28 border-4 border-white rounded-full shadow-lg">
            <img
      ...
      <div className="pt-20 px-6 sm:px-10">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-700 font-bold">100 Followers</p>
          </div>
          <div className='flex'>
        ...
        >
            <FaHeart className={`text-xl transition-colors ${!isFollowing ? "text-black" : "text-white"}`} />
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              ...
              <p className="text-sm text-gray-500">{new Date(profileData.createdAt).toLocaleString()}</p>
            </div>
            <div>
              <label className="label"><span className="label-text">Last Updated</span></label>
              <p className="text-sm text-gray-500">{new Date(profileData.updatedAt).toLocaleString()}</p>
            </div>
          </div>
